...
idle = formar_lista_animacao(
    idle_spritesheet, idle_number_frames, idle_size_of_frame_x, idle_size_of_frame_y, 1)
...
walk = formar_lista_animacao(
    walk_spritesheet, walk_number_frames, walk_size_of_frame_x, walk_size_of_frame_y, 1)
...
jump_size_of_frame_x = 135
jump_size_of_frame_y = 184

jump = formar_lista_animacao(
    jump_spritesheet, jump_number_frames, jump_size_of_frame_x, jump_size_of_frame_y, 1)
...
punch_size_of_frame_x = 72
punch_size_of_frame_y = 125

punch = formar_lista_animacao(
    punch_spritesheet, punch_number_frames, punch_size_of_frame_x, punch_size_of_frame_y, 1)
...
kick_size_of_frame_x = 58
kick_size_of_frame_y = 97

kick = formar_lista_animacao(
    kick_spritesheet, kick_number_frames, kick_size_of_frame_x, kick_size_of_frame_y, 1)
