...
from personagens.animations_kanye import idle_p1, idle_p2, walk_p1, walk_p2, jump_p1, jump_p2, punch_p1, punch_p2, kick_p1, kick_p2, derrota
...
class Kanye_fighter():
    def __init__(self, player, x, y):
        self.player = player
        self.rect = pygame.Rect(x, y, 145, 215)
        self.animations = [idle_p1, walk_p1, jump_p1, punch_p1, kick_p1, derrota] if self.player == 1 else [idle_p2, walk_p2, jump_p2, punch_p2, kick_p2, derrota]
